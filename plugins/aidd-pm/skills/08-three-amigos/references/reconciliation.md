...
| Situation | Result |
| --- | --- |
| equivalent claims | one finding, retaining every role and evidence pointer |
| distinct claims on the same section | both kept |
| contradictory claims | both surfaced and one question asked; no lens ranked above another |
