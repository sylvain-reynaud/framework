...
7. Scaffold from [recipe-template.md](../assets/recipe-template.md) when needed. Apply [recipe-contract.md](../references/recipe-contract.md) to every section; keep techniques isolated and preserve verified commands, examples, limits, screenshots, and evidence while deleting narrative repetition.
