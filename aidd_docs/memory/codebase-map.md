...
flowchart TD
    ...
    Root --> Plugins["plugins/ (7 plugin packages)"]
    ...
    AiddUI --> UISkills["skills/ (01-experience-audit, 02-experience-design, 03-engagement-system)"]
```
